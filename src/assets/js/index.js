...
/* harmony import */ var react_select_async_paginate__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! react-select-async-paginate */ "./node_modules/react-select-async-paginate/es/index.js");
...
const SelectData = _ref => {
  ...
  const [searchPage, setSearchPage] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(1);
  const {
    records,
    hasResolved
    ...
    return {
      records: select(_wordpress_core_data__WEBPACK_IMPORTED_MODULE_3__.store).getEntityRecords(...selectorArgs),
  ...
  const getTheOptions = () => {
    ...
    if (1 === records.length) {
      ...
      return {
        options: [{
          value: records[0].id,
          label: (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_4__.decodeEntities)(records[0].title.rendered)
        }],
        hasMore
      };
    }

    records === null || records === void 0 ? void 0 : records.map(record => options.push({
      value: record.id,
...
/* harmony import */ var _selectData_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./selectData.js */ "./js/selectData.js");
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TabPanel, {
    ...
    if ('selectData' === field.type) {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        key: key,
        className: 'wax-components-field'
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_selectData_js__WEBPACK_IMPORTED_MODULE_12__.SelectData, {
        fieldValue: field.value,
        field: field,
        onChange: onChangeField
      }));
