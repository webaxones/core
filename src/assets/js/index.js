...
const SelectData = _ref => {
  ...
  const records = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(select => select(_wordpress_core_data__WEBPACK_IMPORTED_MODULE_2__.store).getEntityRecords(data === null || data === void 0 ? void 0 : data.kind, data === null || data === void 0 ? void 0 : data.name), []);
  let options = [];
  ...
  records === null || records === void 0 ? void 0 : records.map(record => options.push({
    value: record.id,
    label: (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_3__.decodeEntities)(record.title.rendered)
  }));
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(RecordsList, {
    records: options,
